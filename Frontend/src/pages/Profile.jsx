...
function Profile() {
  ...
  const getUserProjects = async() =>{
    try {
      const response = await axios.get(`https://idealab-fwjb.onrender.com/api/v1/projects/getproject/${username}`)
  ...
  const getUserIdeas = async() =>{
    try {
      const response = await axios.get(`https://idealab-fwjb.onrender.com/api/v1/ideas/getidea/${username}`)
  ...
  const handleprojectDelete = async(project) =>{
    console.log("id : ",project._id);
     ...
     try {
      const response = await axios.delete(`https://idealab-fwjb.onrender.com/api/v1/projects/delete/${project._id}`)
  ...
  const handleideaDelete = async(idea) =>{
     ...
     try {
      const response = await axios.delete(`https://idealab-fwjb.onrender.com/api/v1/ideas/delete/${idea._id}`)
      console.log(response);
